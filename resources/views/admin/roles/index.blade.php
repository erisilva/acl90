  ...
  <div class="btn-group py-1" role="group" aria-label="Opções">
    ...
    <div class="btn-group" role="group">
      ...
      <ul class="dropdown-menu" aria-labelledby="btnGroupOpcoes">
        ...
        <li><a class="dropdown-item" href="#" id="btnExportarXLS"><i class="bi bi-file-earmark-spreadsheet-fill"></i> Exportar Planilha Excel</a></li>
        <li><a class="dropdown-item" href="#" id="btnExportarCSV"><i class="bi bi-file-earmark-spreadsheet-fill"></i> Exportar Planilha CSV</a></li>
            ...
            <tr>
                ...
                <td>
                  <div class="btn-group" role="group">
                    ...
                    <a href="{{route('roles.show', $role->id)}}" class="btn btn-info btn-sm" role="button"><i class="bi bi-eye"></i></a>
                  </div>
                </td>
            </tr>    
            @endforeach                                                 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="GET" action="{{ route('roles.index') }}">
          ...
          <a href="{{ route('roles.index') }}" class="btn btn-secondary btn-sm" role="button"><i class="bi bi-x-octagon"></i> Limpar</a>
        </form>
